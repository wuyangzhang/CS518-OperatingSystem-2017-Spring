...
//			if(strcmp(ibitmap_check, ibitmap) == 0){
//				log_msg("ibitmap_check[1]=%c", ibitmap[1]);
//				if(ibitmap_check[0] == 0 && ibitmap_check[1] == 1 && ibitmap_check[SFS_INODES_NUM - 1] == 1){
//					log_msg("\n	inode bitmap is correct. ibitmap[1]=%c", ibitmap);
//				}
//			}
...
//			if(strcmp(dbitmap, dbitmap_check) == 0){
//				if(dbitmap_check[0] == 1 && dbitmap_check[1] == 1 && ibitmap_check[SFS_DATA_BLKS_NUM - 1] == 1){
//                                        log_msg("\n     datablock bitmap is correct.");
//                                }
//			}
			...
			log_msg("\n	inode root:\n		inode num:%d\n           inode type:%d\n           inode time:%d\n", ino_root_check.iid, ino_root_check.flag, ino_root_check.accessed_time);
			/***************************/
